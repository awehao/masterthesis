...
run_one "DISC-A  poses A" discA evaluation/results/bigarena_poses.csv
run_one "DISC-B  poses B" discB evaluation/results/bigarena_poses_b.csv
echo "[$(date +%T)] disc-collision sweep complete"
