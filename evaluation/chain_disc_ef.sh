...
run_one "DISC-E  poses C" discE evaluation/results/bigarena_poses_e.csv
run_one "DISC-F  poses D" discF evaluation/results/bigarena_poses_f.csv
echo "[$(date +%T)] disc EF sweep complete"
