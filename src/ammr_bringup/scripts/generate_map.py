...
DYNAMIC_OBSTACLES = [
    ...
    ('0.6 0.2 0.8 1', [(_B*0.3, -_B*0.3, 0), (_B*0.3,  _B*0.3, 12), (_B*0.3, -_B*0.3, 24)]),   # 紫：右中上下
    ('0.8 0.4 0.0 1', [(-_B*0.2, _B*0.2, 0), (_B*0.2, -_B*0.2, 14), (-_B*0.2, _B*0.2, 28)]),   # 棕：中央小斜
    ('0.0 0.6 0.4 1', [(-_B*0.4, _B*0.0, 0), (_B*0.4,  _B*0.0, 16), (-_B*0.4, _B*0.0, 32)]),   # 青綠：中線左右
    ('0.9 0.1 0.6 1', [(_B*0.0, -_B*0.7, 0), (_B*0.0,  _B*0.2, 14), (_B*0.0, -_B*0.7, 28)]),   # 粉紫：中線上下
    ('0.4 0.8 0.2 1', [(-_B*0.6, -_B*0.1, 0), (_B*0.1, _B*0.5, 20), (-_B*0.6, -_B*0.1, 40)]),  # 黃綠：大斜線
]
